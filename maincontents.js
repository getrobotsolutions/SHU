...
function FC_ContentsCall(strContentsName, strLanguage)
{
   // alert(strContentsName);
    ...
    switch (strContentsName)
    {
        ...
        case "NewBuilding":
            PlaySpeech(speak[0]);
            location.href = "Contents/NewBuilding/index.html";
            break;
        case "BuildingMaps":
            PlaySpeech(speak[1]);
            location.href = "Contents/BuildingMaps/index.html";
            break;
        case "CampusMap":
            PlaySpeech(speak[2]);
            location.href = "Contents/CampusMap/index.html";
            break;
        case "DeanMessage":
            PlaySpeech(speak[3]);
            location.href = "Contents/DeanMessage/index.html";
            break;
        case "ProgramFact":
            PlaySpeech(speak[4]);
            location.href = "Contents/ProgramFact/index.html";
            break;
        case "Info":
            //PlaySpeech(speak[5]);
